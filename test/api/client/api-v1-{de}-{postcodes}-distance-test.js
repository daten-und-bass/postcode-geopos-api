...
describe('/api/v1/{de}/{postcodes}/distance', function() {
  describe('get', function() {
    it('should respond with 200 Success for Content-Type application/json', function(done) {
      ...
      /*eslint-enable*/
      request({
        url: 'https://localhost:10011/api/v1/de/postcodes/distance',
        json: true,
        qs: {
          start: '53121',
          end: '19059',
      ...
      function(error, res, body) {
        ...
        expect(body[0]).to.equal('437934.4121');
        expect(body[1]).to.equal('m');
