...
describe('/api/v1/{de}/{postcodes}/position/{postcode}', function() {
  describe('get', function() {
    it('should respond with 200 Success for Content-Type application/json', function(done) {
      ...
      /*eslint-enable*/
      request({
        url: 'https://localhost:10011/api/v1/de/postcodes/position/74172',
        json: true,
        method: 'GET',
        headers: {
      ...
      function(error, res, body) {
        ...
        expect(body[0]).to.equal('9.2159762978553772');
        expect(body[1]).to.equal('49.19485299962076397');
    ...
    it('should respond with default Error for wrong token for Content-Type application/json', function(done) {
      ...
      request({
        ...
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer CompLeteWrOnGToKen123456'
        }
      },
      function(error, res, body) {
        if (error) return done(error);
    ...
    it('should respond with default Error for wrong param pattern for Content-Type application/json', function(done) {
      ...
      /*eslint-enable*/
      request({
        url: 'https://localhost:10011/api/v1/de/postcodes/position/noPostcode',
        json: true,
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
